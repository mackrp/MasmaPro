...
router.get('/', catchErrors(listingController.homePage));
...
router.get('/home', catchErrors(listingController.getListingsByTypes));
router.get('/home/:listingTypes', catchErrors(listingController.getListingsByTypes));
router.get('/states', catchErrors(listingController.getListingsByStates));
router.get('/states/:states', catchErrors(listingController.getListingsByStates));
